...
<div class="d-flex mb-3">
    <button type="button" class="btn btn-primary me-2" style="width: 150px;" data-bs-toggle="modal" data-bs-target="#addModal">
        Tambah Data
    </button>
    <a type="button" class="btn btn-success" href="<?= base_url() ?>produk/download" style="width: 150px;">
        Download
    </a>
</div>
